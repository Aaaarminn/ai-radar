...
def summarize(title, text):
    ...
    fmt_lines.append(
        '详细编译：<按内容类型选格式，输出%s：\n'
        '【新闻/模型发布/重大更新】→ 整理、翻译、总结正文核心内容；'
        '保留关键数据、参数、时间线；用自然段落写，不需要小标题和 advisory；'
        '像一份精炼的新闻编译稿，500~1200字\n'
        '【工具/项目/开源仓库】→ 「这是什么」1~2句 +'
        '「为什么对你有用」结合画像2~3条场景 +'
        '「怎么上手」安装/入门路径 +'
        '「别人怎么用」社区典型用法 +'
        '「注意事项」坑/限制；800~1500字\n'
        '【论文/研究】→ 核心发现 + 实际意义，500~1000字\n'
        '段落清晰；禁止出现媒体名/记者名/日期>' % lang)
